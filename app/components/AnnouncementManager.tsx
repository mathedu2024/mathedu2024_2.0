  ...
  return (
    <div className="page-shell max-w-7xl mx-auto w-full min-w-0 flex flex-col h-full overflow-y-auto animate-fade-in">
      ...
      {isEditing && typeof document !== 'undefined' && createPortal(
        <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 sm:p-6 bg-black/60 animate-fade-in">
          <div
            role="dialog"
            aria-modal="true"
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="flex flex-col flex-1 min-h-0 overflow-visible">
