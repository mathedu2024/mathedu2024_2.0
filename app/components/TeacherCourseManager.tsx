...
function LessonManager({ courseId, courseName, courseCode, onClose }: { courseId: string, courseName: string, courseCode: string, onClose: () => void }) {
  ...
  if (isLoading) {
    return (
      <div className="fixed top-16 inset-x-0 bottom-0 bg-white z-50 flex items-center justify-center">
    ...
    <DragDropContext onDragEnd={onDragEnd}>
      <div className="fixed inset-0 bg-white z-50 flex flex-col items-center justify-start min-h-screen h-full">
        ...
        <div className="sticky top-0 z-10 bg-white flex-shrink-0 p-4 border-b flex justify-between items-center w-full max-w-4xl mx-auto">
          ...
          <button onClick={onClose} className="text-gray-400 hover:text-gray-600 transition-colors z-20 p-2 rounded-full hover:bg-gray-100" aria-label="關閉">
