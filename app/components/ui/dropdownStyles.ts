...
export const DROPDOWN_BUTTON_CLASS =
  'select-unified flex items-center justify-between w-full px-4 py-2.5 text-left border border-gray-300 rounded-xl bg-white focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all sm:text-sm cursor-pointer shadow-sm';
...
export const DROPDOWN_OPTION_ACTIVE_CLASS = 'bg-primary/10 text-on-surface';

export const DROPDOWN_OPTION_INACTIVE_CLASS = 'text-gray-900';

export const MULTISELECT_BUTTON_CLASS =
  'w-full px-4 py-2.5 border border-gray-300 rounded-xl bg-white focus:ring-2 focus:ring-primary focus:border-transparent transition-all shadow-sm outline-none text-sm text-gray-700 cursor-pointer flex items-center justify-between text-left';
