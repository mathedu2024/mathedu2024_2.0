...
function BackPanel() {
  ...
  return (
    <div className="flex h-screen bg-gray-100">
      ...
      {/* 側邊欄 */}
      <aside className={`hidden md:flex flex-col z-40 transition-all duration-300 bg-white border-r ${isSidebarCollapsed ? 'w-16' : 'w-64'}`}
              ...
              <>
                ...
                <div className="pt-0 pb-0 px-0">
                  <button
                    ...
                    className={
                      isSidebarCollapsed
                        ...
                        : "flex items-center w-full h-12 px-0 py-2 rounded-lg transition-colors hover:bg-gray-100 text-gray-700"
                    }
                  ...
                  >
                    ...
                    {!isSidebarCollapsed && <span className="ml-3 text-base">收合選單</span>}
                  </button>
                </div>
              </>
            )}
