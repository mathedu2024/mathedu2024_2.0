        ...
        <div className="min-h-screen flex items-center justify-center p-4">
          <div className="max-w-md w-full bg-white rounded-2xl shadow-2xl border border-gray-100 p-10 text-center">
            ...
            <div className="space-y-4">
              <button
                onClick={reset}
                className="w-full flex items-center justify-center px-6 py-4 bg-primary text-white font-bold rounded-xl hover:bg-primary-hover transition-all shadow-lg shadow-primary/20 hover:-translate-y-0.5 active:translate-y-0"
              >
